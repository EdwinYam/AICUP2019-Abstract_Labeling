...
from allennlp.training.metrics import F1Measure, CategoricalAccuracy, FBetaMeasure
    ...
    def __init__(self, vocab: Vocabulary,
       ...
       # define loss
        if self.sci_sum:
            ...
            self.all_f1_metrics = FBetaMeasure(beta=1.0,
                                               average='micro') 
    ...
    def forward(self,  # type: ignore
        ...
        if labels is not None:
            ...
            if not self.labels_are_scores:
                ...
                self.all_f1_metrics(flattened_probs, flattened_gold, mask=evaluation_mask)
